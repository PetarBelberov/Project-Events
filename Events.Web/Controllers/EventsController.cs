    ...
    public class EventsController : BaseController
    {
        ...
        public ActionResult Edit(int id)
        {
            using (var database = new ApplicationDbContext())
            {
                ...
                model.StartDateTime = events.StartDateTime;
                model.Duration = events.Duration;
                model.Description = events.Description;
                model.Location = events.Location;
                model.IsPublic = events.IsPublic;
       ...
       private Event LoadEvent(int id)
       {
        ...
        public ActionResult Delete(int id, EventViewModel model)
        {
            ...
            {
                this.AddNotification("Cannot delete event #" + id,
                    NotificationType.ERROR);
                return this.RedirectToAction("My");
            }
